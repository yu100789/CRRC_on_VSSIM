...
/* HEADER - Compression MODULE */  // 2021/03/01
#include "huffman.h"
...
cd /var &&\
sudo wget https://cdn.kernel.org/pub/linux/kernel/v4.x/linux-4.1.11.tar.xz &&\
sudo tar xvf linux-4.1.11.tar.xz &&\
sudo rm -r -f linux-4.1.11 &&\
sudo tar xvf linux-4.1.11.tar.xz &&\
sudo rm -r -f linux-4.1.11 &&\
sudo tar xvf linux-4.1.11.tar.xz &&\
sudo rm -r -f linux-4.1.11 &&\
...
sudo rm -r -f linux-4.1.11 &&\
sudo tar xvf linux-4.1.11.tar.xz &&\
sudo rm -r -f linux-4.1.11/crypto &&\
sudo ./run_direct_io_read.sh linux-4.1.11 &&\
sudo tar xvf linux-4.1.11.tar.xz &&\
cd linux-4.1.11 &&\
